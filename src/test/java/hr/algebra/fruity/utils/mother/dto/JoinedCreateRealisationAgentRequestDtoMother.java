...
public class JoinedCreateRealisationAgentRequestDtoMother {

  public static JoinedCreateRealisationAgentRequestDto.JoinedCreateRealisationAgentRequestDtoBuilder complete() {
    return JoinedCreateRealisationAgentRequestDto.builder()
