...
public class CreateWorkAgentRequestDtoMother {

  public static CreateWorkAgentRequestDto.CreateWorkAgentRequestDtoBuilder complete() {
    return CreateWorkAgentRequestDto.builder()
