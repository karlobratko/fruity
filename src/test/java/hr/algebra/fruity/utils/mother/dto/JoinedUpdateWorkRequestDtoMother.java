...
public class JoinedUpdateWorkRequestDtoMother {

  public static JoinedUpdateWorkRequestDto.JoinedUpdateWorkRequestDtoBuilder complete() {
    return JoinedUpdateWorkRequestDto.builder()
