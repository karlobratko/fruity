...
public class JoinedUpdateCadastralParcelRequestDtoMother {

  public static JoinedUpdateCadastralParcelRequestDto.JoinedUpdateCadastralParcelRequestDtoBuilder complete() {
    return JoinedUpdateCadastralParcelRequestDto.builder()
