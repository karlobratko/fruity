...
@SQLDelete(sql = "UPDATE RowCluster SET deleteDate = CURRENT_DATE WHERE id = ?", check = ResultCheckStyle.COUNT)
@Where(clause = RowCluster.Constants.deleteDateColumnName + " IS NULL")
public class RowCluster {
  ...
  @JoinColumn(name = ArcodeParcel.Constants.joinColumnName, nullable = false)
  private @NonNull ArcodeParcel arcodeParcel;
  ...
  public static class Constants {
    ...
    public static final String tableName = "row_clusters";

    public static final String joinColumnName = "row_cluster_fk";

    public static final String idColumnName = "row_cluster_id";
    ...
    public static final String arcodeParcelAndNameUniqueConstraintName = "uq_row_cluster_arcode_parcel_name";
