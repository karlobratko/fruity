...
@SQLDelete(sql = "UPDATE ArcodeParcel SET deleteDate = CURRENT_DATE WHERE id = ?", check = ResultCheckStyle.COUNT)
@Where(clause = ArcodeParcel.Constants.deleteDateColumnName + " IS NULL")
