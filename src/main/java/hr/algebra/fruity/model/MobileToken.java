...
@Entity
@Table(name = MobileToken.Constants.tableName)
@NoArgsConstructor
@AllArgsConstructor
@Builder
@Getter
...
@SQLDelete(sql = "UPDATE mobile_tokens SET delete_date = CURRENT_DATE WHERE mobile_token_id = ?", check = ResultCheckStyle.COUNT)
...
public class MobileToken {
  ...
  @OneToOne(mappedBy = Employee.Fields.mobileToken, fetch = FetchType.EAGER)
  ...
  public static class Constants {
    ...
    public static final String tableName = "mobile_tokens";

    public static final String joinColumnName = "mobile_token_fk";

    public static final String idColumnName = "mobile_token_id";
