...
@Entity
@Table(name = WorkEquipment.Constants.tableName)
...
@SQLDelete(sql = "UPDATE works_equipments SET delete_date = CURRENT_DATE WHERE equipment_fk = ? AND work_fk = ?", check = ResultCheckStyle.COUNT)
...
public class WorkEquipment {
  ...
  @Builder
  public WorkEquipment(WorkEquipmentId id, @NonNull Work work, @NonNull Equipment equipment, BigDecimal costPerHour, String note) {
    this.id = Objects.requireNonNullElse(id, new WorkEquipmentId(work.getId(), equipment.getId()));
    this.work = work;
  ...
  public static class WorkEquipmentId implements Serializable {
  ...
  public static class Constants {
    ...
    public static final String tableName = "works_equipments";

    public static final String joinColumnName = "work_equipment_fk";
